...
pygame.init()
font = pygame.font.Font('nokiafc22.ttf', 20)
...
class SnakeGame:
    ...
    def _update_ui(self):
        ...
        text = font.render("    " + str(self.score), True, GREY)
    ...
    def _high_scores(name):
        f = open("scores.text","a")
        l = f.readlines()
        scores=[]
